...
public class App implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception {
        ...
        User user1 = new User(1L,"Artur", "Silva", "artur@email.com",  new Date(93,01,14), "atcs", passwordEncoder.encode("h3ll0"), "81983351902", null, LocalDate.now(), null);
        User user2 = new User(2L,"Maria", "Silva", "maria@email.com", new Date(90,11,14), "mcsf", passwordEncoder.encode("h3ll038475"), "81975843837", null, LocalDate.now(), null);
        ...
        Car car7 = new Car(7L, 1923, "QYL-3A35", "ASTRA", "MARROM", user2);
